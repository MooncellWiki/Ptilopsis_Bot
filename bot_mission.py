    ...
    for daily_group in mission_table['dailyMissionPeriodInfo']:
        ...
        for period in daily_group['periodList']:
            ...
            if period['missionGroupId'] not in mission_table['missionGroups']:
                continue
            for mission_id in mission_table['missionGroups'][period['missionGroupId']]['missionIds']:
            ...
            for reward_id in mission_table['periodicalRewards']:
                if mission_table['periodicalRewards'][reward_id]['groupId'] == period['rewardGroupId']:
                    reward_content = ''
                    ...
                    reward_list += '\n|-\n|reward set {sort_id}\n|{pointCost}\n|{reward_content}'.format(
                        sort_id = mission_table['periodicalRewards'][reward_id]['sortIndex'],
                        pointCost = mission_table['periodicalRewards'][reward_id]['periodicalPointCost'],
