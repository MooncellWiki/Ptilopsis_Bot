                ...
                if full_path.endswith('.bytes'):
                    ...
                    if fbs_flag:
                        ...
                        if fbs_name is not None:
                            ...
                            os.system(f"{os.path.join('.', 'flatc')} -o {fbs_path} --no-warnings --json --strict-json --natural-utf8 --defaults-json --raw-binary ./OpenArknightsFBS/FBS/{fbs_name}.fbs -- {fbs_path}/{fbs_name}.bytes")
