"""character_table.json 的数据模型。

由 scripts/gen_gamedata_models.py 从 FBS/character_table.fbs 生成,请勿手改;
字段语义见 dump.cs 里的同名类。
"""
...
# JSON 里去掉了外层的 characters,直接是 {id: ...}
CharacterTable = TypeAdapter(dict[str, CharacterData])
