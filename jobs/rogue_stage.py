...
def get_4star_data(stage_detail, level_table, rts):
    stage_4star_data = '\n==突袭==\n{{突袭关卡信息\n'
    ...
    def _run(self):
        ...
        for stage_key in roguelike_table['stages']:
            ...
            if len(linkedStage) >= 1:
                stage_4star_data = get_4star_data(roguelike_table['stages'][linkedStage[0]], level_table, rts)
            else:
                stage_4star_data = ''
